...
Este é o repositório para **Reconhecimento Óptico de Caracteres (OCR)** utilizando o modelo **DeepSeek-OCR**.  
O objetivo é realizar a leitura, extração e validação automática de texto a partir de imagens.
